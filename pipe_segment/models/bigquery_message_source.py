...
class BigQueryMessagesSource:
    ...
    def __init__(
        ...
        table_id: str,
        filter_template: str = DEFAULT_FILTER_TEMPLATE
    ):
    ...
    def _check_sharded_or_partitioned(self, table_id):
        ...
        try:
            ...
            if "Not found" in str(e):
                ...
                self._table_suffix = '*'
                try:
                    self._table = self._bqtools.get_table(
                        dataset_id, f"{table_name}{self._table_suffix}")
    ...
    def filter_messages(self, start_date: datetime, end_date: datetime) -> str:
        return Template(self._filter_template).render({
