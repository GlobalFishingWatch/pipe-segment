...
def define_tables(dataset_out):
    ...
    raw_encounters = DatePartitionedTable(
        table_id=f"{dataset_out}.raw_encounters",
        description=description("Migrating raw encounters sharded to partitioned."),
        schema=Schemas.load_json_schema("./assets/schemas/raw_encounters.schema.json"),
