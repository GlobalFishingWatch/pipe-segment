...
docker compose run --rm --entrypoint pipe dev segment \
    ...
    --out_segmented_messages_table=scratch_matias_ttl7d.messages_segmented \
    --out_segments_table=scratch_matias_ttl7d.segments \
    --fragments_table=scratch_matias_ttl7d.fragments \
