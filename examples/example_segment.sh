...
docker compose run --entrypoint pipe dev segment \
    ...
    --out_segmented_messages_table=scratch_matias_ttl7d.messages_segmented_ \
    --out_segments_table=scratch_matias_ttl7d.segments_ \
    --fragments_table=scratch_matias_ttl7d.fragments_ \
    --in_normalized_sat_offset_messages_table=pipe_ais_sources_v20220628.pipe_nmea_normalized_ \
    --out_sat_offsets_table=scratch_matias_ttl7d.satellite_timing_offsets \
